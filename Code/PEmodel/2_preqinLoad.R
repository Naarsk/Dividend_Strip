...
# Functions including IRR 
{
  ...
  calcIRR <- function(df)
  {
    ...
    for(i in seq_len(nrow(fundList)))
    {
    ...
    df <- left_join(df, fundList, by= "Fund.ID")
    return(df)
  }
...
######################################### LOAD STATIC PREQIN ############################################################################################
preqin.static <- read.csv("C:/Users/leocr/Projects/Economics/Finance/PE_dividend_strip/Data/Preqin_PEPerf_20170919143905AllAlt.csv", stringsAsFactors = FALSE, header=T, sep=",")
...
save(preqin.static, file = "C:/Users/leocr/Projects/Economics/Finance/PE_dividend_strip/Data/PreqinStaticPerformanceAlt.Rda")
...
gpme.all <- rbind(gpme.pe,
                  ...
                  gpme.rs,
                  gpme.vc)
save(gpme.all, file = "C:/Users/leocr/Projects/Economics/Finance/PE_dividend_strip/Data/PreqinGPME.Rda")


# Generates both quarterly and yearly cash flow files

######################################### LOAD PREQIN ############################################################################################
load(file = "C:/Users/leocr/Projects/Economics/Finance/PE_dividend_strip/Data/DiscountRatesOct20.Rda")
load(file = "C:/Users/leocr/Projects/Economics/Finance/PE_dividend_strip/Data/PreqinStaticPerformanceAlt.Rda")
load(file = "C:/Users/leocr/Projects/Economics/Finance/PE_dividend_strip/Data/PreqinGPME.Rda")

df <- read.csv("C:/Users/leocr/Projects/Economics/Finance/PE_dividend_strip/Data/Preqin_PE_CashFlow_202042800_20200428031312.csv", stringsAsFactors = FALSE, header=T, sep=",")
return.data <- read.csv("C:/Users/leocr/Projects/Economics/Finance/PE_dividend_strip/Data/MASTER_Preqin_Returns.csv", stringsAsFactors = FALSE, header=T, sep=",")   
...
dynamicFunds <- NULL
for(j in seq_len(nrow(fundList)))
{
...
save(fund.quarterly, file = "C:/Users/leocr/Projects/Economics/Finance/PE_dividend_strip/Data/YearlyCashFlowOct20.Rda")

# load(file = "C:/Users/leocr/Projects/Economics/Finance/PE_dividend_strip/Data/YearlyCashFlowOct20.Rda")
...
load(file = "C:/Users/leocr/Projects/Economics/Finance/PE_dividend_strip/Data/DividendStripOct20.Rda")
...
save(irr.all, file = "C:/Users/leocr/Projects/Economics/Finance/PE_dividend_strip/Data/IRRJuly20.Rda")
